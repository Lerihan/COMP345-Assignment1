...
private:
	...
	bool attacked; //will store whether the Player has attacked this turn
...
public:
	...
	bool hasAttacked();		//return whether the Player has attacked at least once or not
	void setAttacked(bool b);			//sets the Player's attacked data member to b
